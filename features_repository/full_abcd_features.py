...
def get_full_abcd_feature_configs() -> list[VideoFeature]:
    ...
    feature_configs = [
        ...
        VideoFeature(
            ...
            extra_instructions=[
                "Consider the following criteria for your answer: {criteria}",
                "Provide the exact timestamp when the products {branded_products} or product categories: {branded_products_categories}"
                " are found in any text or overlay in the video.",
            ],
            evaluation_method=EvaluationMethod.LLMS,
            evaluation_function="",
            include_in_evaluation=True,
