...
def detect_brand_mention_speech(
    ...
    Retirns:
        ...
        brand_mention_speech_1st_5_secs: evaluation
    """
    ...
    if use_llms:
        ...
        brand_mention_speech_criteria = """The brand name is heard in the audio or speech at any time in the video."""
    ...
    return brand_mention_speech, brand_mention_speech_1st_5_secs
