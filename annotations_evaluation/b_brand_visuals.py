...
def detect_brand_visuals(
    ...
    """
    brand_visuals, na = detect(feature_name, bucket, annotation_location)
...
def detect_brand_visuals_1st_5_secs(
    ...
    """
    na, brand_visuals_1st_5_secs = detect(feature_name, bucket, annotation_location)
...
def detect(
    ...
    logo_annotation_results = get_logo_annotations(bucket, annotation_location)
