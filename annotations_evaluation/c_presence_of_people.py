...
from helpers.annotations_helpers import calculate_time_seconds, get_people_annotations
...
def detect_presence_of_people(
    ...
    """
    presence_of_people, na = detect(feature_name, bucket, annotation_location)
...
def detect_presence_of_people_1st_5_secs(
    ...
    Returns:
        presence_of_people_1st_5_secs: presence of people evaluation
    """
    na, presence_of_people_1st_5_secs = detect(
...
def detect(
    ...
    Returns:
        ...
        presence_of_people_1st_5_secs: presence of people evaluation
    """
    people_annotation_results = get_people_annotations(bucket, annotation_location)
